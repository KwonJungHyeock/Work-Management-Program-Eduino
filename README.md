...
>
> **설정 백업/복원**: 백엔드가 없어 브라우저 캐시를 지우면 설정이 사라집니다. 상단바 **[설정 백업]** 으로 모든 설정·데이터를 **`.json` 파일**로 내보내고 다시 불러올 수 있습니다(PC 간·직원 간 세팅 공유 겸용). 영구 공용 저장은 이후 가벼운 백엔드(Vercel KV/Upstash 등) 연동 시 대체됩니다.
